...
##Pmod Header JXADC
##Sch name = XA1_P
#set_property PACKAGE_PIN J3 [get_ports {cs}]				
	#set_property IOSTANDARD LVCMOS33 [get_ports {cs}]
##Sch name = XA2_P
#set_property PACKAGE_PIN L3 [get_ports {sdin}]				
	#set_property IOSTANDARD LVCMOS33 [get_ports {sdin}]
##Sch name = XA3_P
...
#set_property PACKAGE_PIN N2 [get_ports {sclk}]				
	#set_property IOSTANDARD LVCMOS33 [get_ports {sclk}]
##Sch name = XA1_N
#set_property PACKAGE_PIN K3 [get_ports {d_cn}]				
	#set_property IOSTANDARD LVCMOS33 [get_ports {d_cn}]
##Sch name = XA2_N
#set_property PACKAGE_PIN M3 [get_ports {resn}]				
	#set_property IOSTANDARD LVCMOS33 [get_ports {resn}]
##Sch name = XA3_N
#set_property PACKAGE_PIN M1 [get_ports {vccen}]				
	#set_property IOSTANDARD LVCMOS33 [get_ports {vccen}]
##Sch name = XA4_N
#set_property PACKAGE_PIN N1 [get_ports {pmoden}]				
	#set_property IOSTANDARD LVCMOS33 [get_ports {pmoden}]
